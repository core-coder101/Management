  ...
  <aside className="main-sidebar sidebar-dark-primary elevation-4">
    ...
    <div className="sidebar">
      ...
      <div className="user-panel mt-3 pb-3 mb-3 d-flex">
        <div className="image">
          <img
            src={require("../dist/img/user2-160x160.jpg")}
                  ...
                  <ul className="contacts-list">
                    ...
                    <li>
                      <a href="#">
                        <img
                          className="contacts-list-img"
                          src={require("../dist/img/user7-128x128.jpg")}
                          alt="User Avatar"
                        />
                        <div className="contacts-list-info">
                          <span className="contacts-list-name">
                    ...
                    <li>
                      <a href="#">
                        <img
                          className="contacts-list-img"
                          src={require("../dist/img/user5-128x128.jpg")}
                          alt="User Avatar"
                        />
                        <div className="contacts-list-info">
                          <span className="contacts-list-name">
                    ...
                    <li>
                      <a href="#">
                        <img
                          className="contacts-list-img"
                          src={require("../dist/img/user6-128x128.jpg")}
                          alt="User Avatar"
                        />
                        <div className="contacts-list-info">
                          <span className="contacts-list-name">
